...
<?php foreach($extraStylesheets as $sheet): ?><link rel="stylesheet" href="<?=e(app_url((string)$sheet))?>"><?php endforeach; ?>
</head>
...
<main class="app-main">
<?php else: ?>
<header class="site-header"><div class="shell nav-shell"><a class="brand" href="<?=e(app_url('index.php'))?>"><?php if($siteLogo):?><img class="brand-logo-image" src="<?=e($siteLogo)?>" alt="<?=e($siteName)?>"><?php else:?><span class="brand-mark">◒</span><span><?=e($siteName)?></span><?php endif;?></a><nav class="nav-actions" aria-label="Primary"><a href="<?=e(app_url('diagnosis.php'))?>">Self-Diagnosis</a><a href="<?=e($current==='index.php'?'#off-duty-goods':app_url('index.php#off-duty-goods'))?>">Shop</a><a href="<?=e(app_url('professional-assessment.php'))?>">Professional Assessment</a><a class="text-button" href="<?=e(app_url('login.php'))?>">Log in</a></nav></div></header><main>
<?php endif; ?>
