...
<?php if($activeAgent==='overview'){require __DIR__.'/trip-action-queue.php';require __DIR__.'/trip-affordability-summary.php';require __DIR__.'/trip-spend-summary.php';} ?>
