...
if(strpos($service,"\$details['reservation']??null")===false||strpos($service,"\$details['id']??null,\$details['order']")===false){fwrite(STDERR,"Booking.com state mapping must keep reservation and order identifiers distinct.\n");exit(1);}
