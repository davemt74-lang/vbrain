...
$manage=$read('trip-collaboration.php');foreach(['Collaborative Trips & Travelers','Create invitation link','Copy this link now','Co-planner','Traveler — view, RSVP, vote','Viewer — read-only','revoke_invite','change_role','remove_member','Private Traveler Memory'] as $needle){if(stripos($manage,$needle)===false){fwrite(STDERR,"Collaboration management UI missing {$needle}\n");exit(1);}}
