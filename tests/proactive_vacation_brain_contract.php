...
$context=$read('app/Services/LiveTravelAgentContextService.php');foreach(['ProactiveTravelService','agentContext','PROACTIVE TRIP STATE','no provider refresh','payment data','private Trip Memory notes'] as $needle){if(stripos($context,$needle)===false){fwrite(STDERR,"Main Vacation Brain proactive grounding missing {$needle}\n");exit(1);}}
