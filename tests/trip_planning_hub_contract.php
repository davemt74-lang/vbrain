...
$hubJs=$read('assets/trip-planning-hub.js');foreach(['data-plan-brain','setTimeout','document.visibilityState','30000'] as $needle){if(strpos($hubJs,$needle)===false){fwrite(STDERR,"Planning hub live activity client missing {$needle}\n");exit(1);}}
