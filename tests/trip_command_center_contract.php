...
$dream=$read('dream.php');foreach(['view=operations','trip-command-center.php','data-vb-command-config','api/trip-command-center.php','trip-command-center.js'] as $needle){if(strpos($dream,$needle)===false){fwrite(STDERR,"Command Center Plan Trip mount missing {$needle}\n");exit(1);}}
