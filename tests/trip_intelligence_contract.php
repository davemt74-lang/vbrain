...
foreach(['Active agent results','trip-agent-current-result','trip-agent-history','Proactive update'] as $needle){if(strpos($panel,$needle)===false){fwrite(STDERR,"Trip agent result panel missing {$needle}\n");exit(1);}}
