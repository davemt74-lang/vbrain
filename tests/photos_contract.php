...
$css=file_get_contents($root.'/assets/photos.css')?:'';
...
if(strpos($css,'.photos-page [hidden]{display:none!important}')===false){fwrite(STDERR,"Photos hidden-state CSS regression guard missing\n");exit(1);}
