...
CREATE TABLE trip_resolution_entries (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  KEY idx_trip_resolution_entry_case (resolution_case_id,created_at,id),
  KEY idx_trip_resolution_entry_trip (dream_trip_id,currency,entry_type),
...
CREATE TABLE trip_resolution_events (
  ...
  event_type ENUM('case_created','status_changed','entry_added','evidence_added','deadline_attention','followup_attention','closed') NOT NULL,
