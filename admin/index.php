...
<div class="dashboard-head"><div><div class="eyebrow">Admin</div><h1>Vacation Brain Control Room</h1><p class="muted">Content, AI providers, live travel providers, seed generation, review, users, and Travel Match operations.</p></div><a class="button primary small" href="<?=e(app_url('admin/ai-content.php'))?>">AI Content Factory</a></div>
